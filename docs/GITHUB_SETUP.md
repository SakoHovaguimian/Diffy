...
Pull request **Review** now opens a dedicated workspace in the main window, with Conversation, Commits, Files Changed, revision-bound AI views, and local analysis history. See [AI review setup](AI_REVIEW.md) for provider APIs, installed command-line tools, Review Notes, and explicit patch application.
