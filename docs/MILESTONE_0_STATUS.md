...
- Aligned side-by-side and unified source rows, line numbers, lightweight syntax color, sample inline emphasis, synchronized scrolling, context collapsing, search navigation, optional trailing guides and changed-region framing, display preferences, and source-range selection.
