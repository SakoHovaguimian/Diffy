...
enum MockCodeFixtures {
    ...
    static let themeLines: [DiffLine] = aligned([
        ...
        ("        self.theme == .system", "        self.theme == .system"),
        ("    }", "    }"),
        ("", ""),
        ("    var displayName: String {", "    var displayName: String {"),
        ("        self.theme.displayName", "        self.theme.displayName"),
        ("    }", "    }"),
        ("", ""),
        ...
        ("    }", "    }"),
        ("", ""),
        ("    func resolveTheme(for appearance: Appearance) -> Theme {", "    func resolveTheme(for appearance: Appearance) -> Theme {"),
        ("", ""),
        ("        if appearance == .dark {", "        if appearance == .dark {"),
        ("            return .midnight", "            return .midnight"),
        ("        }", "        }"),
        ("", ""),
        ("        return .porcelain", "        return .porcelain"),
        ("", ""),
        ("    }", "    }"),
        ("", ""),
        ...
        ("    }", "    }"),
        ("", ""),
        ("    func resetTheme() {", "    func resetTheme() {"),
        ("", ""),
        ("        self.theme = .default", "        self.theme = .default"),
        ("", ""),
        ("    }", "    }"),
        ("", ""),
        ("    func previewTheme(_ theme: Theme) -> ThemePreview {", "    func previewTheme(_ theme: Theme) -> ThemePreview {"),
