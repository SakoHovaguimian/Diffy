...
| AI review | AIReviewWorkspaceViewModel / AIReviewServiceProtocol | User-triggered bounded context; common strict schemas; append-only history; exact revisions and captured historical files; named loading stages in Ask AI, with active request progress visible after the composer closes |
